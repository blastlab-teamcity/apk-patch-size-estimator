...
def main():
  ...
  print ("##teamcity[buildStatisticValue key='Apk size on disk' value='{}']".format(new_file_size/(1024*1024)))
  ...
  print ("##teamcity[buildStatisticValue key='Apk size for new installs' value='{}']".format(gzipped_size/(1024*1024)))
  ...
  print ("##teamcity[buildStatisticValue key='Apk size for updates' value='{}']".format(bsdiff_size/(1024*1024)))
